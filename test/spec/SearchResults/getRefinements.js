...
test('getRefinements(facetName) returns a refinement(disjunctive) when a disjunctive refinement is set', function (t) {
...
test('getRefinements(facetName) returns a refinement(hierarchical) when a disjunctive refinement is set', function (t) {
...
test('getRefinements(facetName) returnes a refinement(tag) when a tag is set', function (t) {
  ...
  t.deepEqual(refinements, [{ attributeName: '_tags', name: 'foo', type: 'tag' }, { attributeName: '_tags', name: 'bar', type: 'tag' }]);
