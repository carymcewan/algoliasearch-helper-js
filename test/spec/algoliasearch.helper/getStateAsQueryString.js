...
test('getStateAsQueryString', function (t) {
  ...
  t.equal(helper.getStateAsQueryString(), 'q=hello%20mama&fR[color][0]=white&hFR[products][0]=fruits%20%3E%20bananas');
...
test('getStateAsQueryString({safe: true})', function (t) {
  ...
  helper.toggleRefine('color', 'white');
  helper.toggleRefine('products', 'fruits > bananas');
  t.equal(helper.getStateAsQueryString({ safe: true }), 'q=hello%20mama&fR%5Bcolor%5D%5B0%5D=white&hFR%5Bproducts%5D%5B0%5D=fruits%20%3E%20bananas');
