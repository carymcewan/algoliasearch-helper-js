...
test('[INT][DERIVE] Query the same index twice with different query', function (t) {
  t.plan(5);

  setup(indexName, function (client, index) {
    return index.addObjects([{ objectID: '0', content: 'tata' }, { objectID: '1', content: 'toto' }]).then(function (content) {
