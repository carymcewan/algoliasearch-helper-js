...
test('[INT][SEARCHONCE] Should be able to search once with custom parameters without changing main search state', function (t) {
  setup(indexName, function (client, index) {
    return index.addObjects([{ objectID: '1', facet: ['f1', 'f2'] }, { objectID: '2', facet: ['f1', 'f3'] }, { objectID: '3', facet: ['f2', 'f3'] }]).then(function () {
